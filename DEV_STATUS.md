...
> 최종 업데이트: 2026-03-14
> 최신 커밋: `7962d50` (Fix post-shadcn layout issues and data display bugs)
...
| 2026-03-14 | `c5c44c9` | 대시보드 API 최적화 + 정적 에셋 캐싱 |
| 2026-03-14 | `301752b` | Examinee INSERT에 loginFailCount 컬럼 누락 수정 |
| 2026-03-13 | `c0fcc21` | RegistrationListPage API 응답 매핑 수정 |
| 2026-03-13 | `1aefbc6` | tsc -b 빌드 에러 수정 (adminApi 제네릭 타입 파라미터) |
| 2026-03-13 | `0bc2970` | 중복 접수 방지 멱등성 처리 (P2010 에러 핸들링) |
| 2026-03-13 | `32bd7da` | 수동 승인 → 자동 대상자 검증으로 전환 |
| 2026-03-13 | `8a6f3b2` | 수험표 PDF 다운로드 기능 |
| 2026-03-12 | `903aca9` | Docker 빌드 시 프로덕션 API URL 수정 |
